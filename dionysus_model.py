from dionysus_layers import (q_y__x,q_k__y,p_y__k,q_z__y_x,p_x__y_z)
...
class Supervised_Dionysus(Model):

    def __init__(self,Batch_Norm = False):
        super(Supervised_Dionysus,self).__init__()
