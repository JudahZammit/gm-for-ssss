...
class SkipFuncCaerus():
    ...
    def viz(self):
        ...
        out['p_z2_u'] = self.p_z2__z3(
                (out['z2_sample_u'],out['z3_sample_u']))
...
#         self.add_metric(true_iou,name= 'Recon IOU', aggregation= 'mean')
        ...
        model = Model(inputs = [x_u],outputs = out)
        model.compile(optimizer = 'adam')
        plot_model(model,to_file='model_output/SkipFuncCaerus/caerus_skip_func_un_viz.png',expand_nested = True)
