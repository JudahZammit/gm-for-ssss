...
#        actual_out['k5_u'] = out['k5_sample_u']
        ...
        model = Model(inputs = [x_s,y_s],outputs = actual_out)
        model.compile(tf.keras.optimizers.Adam(lr=.001,clipnorm = 1.,clipvalue = 0.5))

        plot_model(model,to_file='model_output/caerus_func_sup_viz.png',expand_nested = True)
